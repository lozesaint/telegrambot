...
#
#
# @dp.message_handler(CommandStart, text_contains="start")
...
#     await call.message.answer(_("Great! Let's get started!", locale=lang))
#
#
...
#
#
# @dp.message_handler(regexp=r"^[0-9]+$", state=states.Purchase.EnterQuantity)
